const getCloudFrontDistributionId = async (serverless) => {
    const awsClient = serverless.getProvider('aws'),
        ...
        listStacksResponse = await awsClient.request('CloudFormation', 'listStackResources', requestParams),
        apiDistribution = listStacksResponse.StackResourceSummaries
    ...
    return apiDistribution.PhysicalResourceId;
};
